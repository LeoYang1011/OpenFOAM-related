...
:
    ...
    waveReals_( List<scalar> (1, -1.0) ),
    waveImags_( List<scalar> (1, -1.0) ),
    waveLength_(-1),
...
:
    ...
    waveReals_(ptf.waveReals_),
    waveImags_(ptf.waveImags_),
...
:
    ...
    waveReals_( dict.lookupOrDefault("waveReals", List<scalar> (1, -1.0)) ),
    waveImags_( dict.lookupOrDefault("waveImags", List<scalar> (1, -1.0)) ),
...
void Foam::waveVelocityFvPatchVectorField::updateCoeffs()
{
    ...
    if (!allCheck_ || reread)
    {
        ...
        {
            #include "checkInputErrorsIrregularPre.H"
        }
    ...
    {
        #include "calculatedLevelIrregularPre.H"
    }
    else if ( waveType_ == "wavemaker" )
    {
